...
import { Lightbulb, Wand2, Download, ArrowRight, CheckCircle2 } from 'lucide-react'
import { motion } from "framer-motion"

const steps = [
  {
    title: "Describe Your Brand",
    description: "Tell us about your brand's personality, values, and target audience. We'll use this information to create the perfect logo for you.",
    icon: Lightbulb,
    benefits: ["AI-powered brand analysis", "Detailed customization options", "Smart suggestions"],
  },
  {
    title: "AI Generation",
    description: "Our advanced AI creates multiple unique logo concepts based on your input, ensuring each design matches your brand identity.",
    icon: Wand2,
    benefits: ["Multiple variations", "Real-time preview", "Style customization"],
  },
  {
    title: "Download & Use",
    description: "Choose your favorite design, make final adjustments if needed, and download in multiple formats ready for use.",
    icon: Download,
    benefits: ["High-resolution files", "Multiple formats", "Full ownership"],
  },
]
      ...
      <div className="container relative">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Our AI-powered platform simplifies logo creation while ensuring professional results.
