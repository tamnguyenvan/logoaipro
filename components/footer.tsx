...
const footerLinks = {
  ...
  freeTools: [
    { name: "Logo Generator", href: "#" },
    { name: "Brand Kit", href: "#", isNew: true },
    { name: "Color Palette", href: "#" },
    { name: "Font Pairing", href: "#" },
    { name: "Icon Library", href: "#", isNew: true },
    { name: "Logo Templates", href: "#" },
...
export default function Footer() {
  return (
    <footer className="bg-[#5D00FF] text-white">
